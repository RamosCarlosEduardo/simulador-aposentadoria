...
// Aporte inicial
// Aporte recorrente
// Quanto deseja receber após se aposentar
// Rentabilidade anual
// Inflação anual
...
function App() {
  ...
  return (
    ...
    >
        <Form className='flex flex-col w-fit items-center text-center border-2 border-blue-200 bg-zinc-50 rounded-md gap-3 p-5'>
          <div className="flex justify-between w-full px-5 gap-5">
            ...
            <Field 
              ...
              id="ageCurrent"
              name="ageCurrent"
              className="ring-1 ring-blue-300 rounded text-center outline-none focus:shadow-sm focus:shadow-cyan-400"
            />
          </div>
          <div className="flex justify-between w-full px-5 gap-5">
          ...
          <div className="flex justify-between w-full px-5 gap-5">
            <label htmlFor="rentability" className=''>Retabilidade anual</label>
            <Field 
              type="number"
              id="rentability"
              name="rentability"
          ...
          <div className="flex justify-between w-full px-5 gap-5">
            <label htmlFor="inflaction" className=''>Retabilidade anual</label>
            <Field 
              type="number"
              id="inflaction"
              name="inflaction"
          ...
          <button 
            type="submit"
            className="bg-green-500 rounded-md px-4 py-2 text-zinc-900"
          >
              Calcular
          </button>
        {calculated && <span>
          {`Você terá acumulado: ${formataBRL(fvCalculated)}`}
        </span>
        }
        </Form>
    </Formik>
